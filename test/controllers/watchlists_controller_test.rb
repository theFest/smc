...
class WatchlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watchlist" do
    assert_difference('Watchlist.count') do
      post watchlists_url, params: { watchlist: { added: @watchlist.added, movie: @watchlist.movie } }
    end
  ...
  test "should update watchlist" do
    patch watchlist_url(@watchlist), params: { watchlist: { added: @watchlist.added, movie: @watchlist.movie } }
